...
func TestWriteManifestIncludesRuntimeSummaryFields(t *testing.T) {
	...
	if err := WriteManifest(path, "source.mkv", sourceDurationMS, playableDurationMS, streams, segments, "fake-engine", ModelParakeet06B, "cuda", "openai/gpt-4o-mini", true, "", false, additional, nil, nil, nil); err != nil {
