...
func (c ExAppConfig) installRoutes(root *http.ServeMux, stateDir string, logger *log.Logger, search searchDeps) *LifecycleHandlers {
	...
	ncProxy := c.ncFilesProxy(logger, search)
