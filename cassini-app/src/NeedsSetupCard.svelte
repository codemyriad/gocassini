...
<style>
  /* The card the operator's own panels draw (NeedsProviderCard): the app's
     colour as a wash with no outline, because this stands in for the insight
     that cannot be made yet rather than warning about one. */
