...
- Every line in Problem, every Evidence cell and every shape part carries either a speaker label and a timestamp in the form "Speaker Name at 12:04", or the word "implied" followed by the reasoning. Anything you cannot trace to the transcript is dropped rather than written.
