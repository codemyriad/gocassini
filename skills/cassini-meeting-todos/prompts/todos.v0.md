...
- Every item is a checkbox line taking exactly one of these four shapes, and no other:
  - "- [ ] <what they will do> — committed at MM:SS" — they said they would do it.
  - "- [ ] <what they will do> — accepted at MM:SS" — someone else asked and they agreed.
  - "- [ ] <what was asked of them> — assigned by <speaker label> at MM:SS, not acknowledged" — someone assigned it and they never answered.
  - "- [ ] <the work> — raised at MM:SS, unowned" — nobody claimed it. This shape appears only under "Unassigned".
- MM:SS is the start of the transcript segment in which the commitment happened, taken from the segment timings in the input. If the input carries no timings — the markdown rendering of a bundle does not, only the JSON form does — drop " at MM:SS" from the shape and keep the rest of it. Never write a timestamp you did not read.
